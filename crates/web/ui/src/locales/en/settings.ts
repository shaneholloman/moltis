...
export default {
	...
	memory: {
		...
		builtInSearchType: "FTS5 + vector (brute-force)",
		zvecSearchType: "HNSW + FTS (native)",
		qmdSearchType: "BM25 + vector + LLM",
		externalDependency: "External dependency",
		noDependency: "None",
		cppZvecLibrary: "C++ zvec library",
		nodejsBun: "Node.js/Bun",
		embeddingCache: "Embedding cache",
		batchOperations: "Batch operations",
		gracefulFallback: "Graceful fallback",
		fallbackToSqlite: "\u2713 (\u2192 SQLite)",
		notApplicable: "N/A",
		reranking: "Reranking",
		rerankingBuiltIn: "\u2713",
		rerankingZvec: "\u2713 (RRF + Weighted)",
		rerankingQmd: "\u2713 (LLM)",
		builtInBestFor: "General use",
		zvecBestFor: "Vector-native workloads",
		qmdBestFor: "Research / QA",
		...
		zvecLabel: "Zvec (Experimental)",
		redbLsmTree: "redb (LSM-tree)",
