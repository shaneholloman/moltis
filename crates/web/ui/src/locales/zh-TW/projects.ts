...
export default {
	title: "儲存庫",
	description:
		"專案會將工作階段繫結至程式碼庫目錄。工作階段連結專案後，系統會自動載入上下文相關檔案（CLAUDE.md、AGENTS.md、.cursorrules 及規則目錄），掃描高風險的提示詞注入模式，再加入系統提示詞。啟用自動 worktree 後，系統會為每個工作階段建立專屬的 git 分支，讓作業彼此隔離。",
	...
	clearAllHint: "「全部清除」只會從 Moltis 中移除儲存庫紀錄，不會刪除磁碟上的任何檔案。",
	...
	clearAllTooltip: "從 Moltis 中移除所有儲存庫紀錄，不刪除磁碟上的檔案",
	pathInput: {
		directory: "目錄",
