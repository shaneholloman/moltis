...
export default {
	...
	config: {
		...
		autoReloadHint: "伺服器重新上線後，頁面會自動重新載入。",
		resetConfirm:
	...
	tailscale: {
		title: "Tailscale",
		description:
			"使用 Tailscale Serve（僅限 tailnet 的 HTTPS）或 Funnel（公開 HTTPS）對外開放閘道。閘道仍繫結在 localhost，並由 Tailscale 代理流量。",
	...
	memory: {
		...
		qmd: "QMD",
		searchType: "搜尋類型",
		builtInSearchType: "FTS5 + 向量（窮舉搜尋）",
		...
		embeddingCache: "嵌入快取",
		batchOperations: "批次作業",
		gracefulFallback: "自動備援",
		...
		rerankingQmd: "\u2713（LLM）",
		builtInBestFor: "一般用途",
		zvecBestFor: "以向量為核心的工作負載",
		qmdBestFor: "研究／問答",
		openAiBatch: "OpenAI 批次 API",
		openAiBatchDiscount: "\u2713（費用降低 50%）",
		...
		llmRerankingDescription: "使用 LLM 重新排序搜尋結果，以提高相關性（速度較慢，但準確度較高）。",
